  ...
  const testimonials = [
    {
      id: 1,
      content:
        "The AV Champs EVENTS Calendar tracks trade shows, events, webinars, and training sessions, saving me time and keeping me updated on industry happenings.",
      author: "Bharat Dhane",
      role: "AV Engineer",
      avatar: "/avatar1.png",
      rating: 5,
