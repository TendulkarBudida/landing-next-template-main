  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      type: "bot",
      content: "👋 Hi there! I am AV Assistant. How can I help you today?",
      timestamp: new Date(),
    },
  ])
              ...
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <Avatar className="h-12 w-12 border-2 border-white/20">
                    <AvatarImage src="/chatbot-icon.png" alt="AV Assistant" />
                ...
                <div>
                  <h3 className="font-medium text-sm text-white">AV Assistant</h3>
